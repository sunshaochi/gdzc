...
public class EditInventoryAdapter extends MyRecyclerView.Adapter<EditInventoryAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public EditInventoryAdapter(Context context) {
        mContext = context;
