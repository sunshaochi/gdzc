...
public class MyChatFragment extends ChatBaseFragment implements ChatManager.MessageListener, EmojiconManager.EmojiconManagerDelegate {
...
//            EMLog.d(TAG, "waitCount--num:" + num);
    ...
    protected ChatFragment.EaseChatFragmentListener chatFragmentListener;

    public void setChatFragmentListener(ChatFragment.EaseChatFragmentListener chatFragmentListener) {
