...
public class AlertTextDialog extends Dialog {

    protected AlertTextDialog(Context context) {
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            mContentView = LayoutInflater.from(mContext).inflate(
                    R.layout.alert_text_dialog, null);
            textView = mContentView.findViewById(R.id.tv_text);
        ...
        public AlertTextDialog create() {
            final AlertTextDialog dialog = new AlertTextDialog(mContext);
        ...
        public AlertTextDialog show() {
            AlertTextDialog dialog = create();
