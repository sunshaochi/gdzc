...
//        mCurrentSelected = datas.size() / 2;
    ...
    private void moveHeadToTail() {
        User head = mDataList.get(0);
        mDataList.remove(0);
        mDataList.add(head);
    }

    private void moveTailToHead() {
        User tail = mDataList.get(mDataList.size() - 1);
...
//        mMinTextSize = mMaxTextSize / 2f;
    ...
    private void init() {
        ...
        mMaxTextSize = DensityUtils.sp2px(getContext(), 18);
        mMinTextSize = DensityUtils.sp2px(getContext(), 13);
    }
    ...
    private void drawData(Canvas canvas) {
        ...
        drawLine(canvas, (float) ((mViewHeight / 2.0) - DensityUtils.dp2px(getContext(), 18)));
        drawLine(canvas, (float) ((mViewHeight / 2.0) + DensityUtils.dp2px(getContext(), 18)));

        int indexs = mCurrentSelected;
        String textData = mDataList.get(indexs).getUser_name();
        canvas.drawText(textData, x, baseline, mPaint);

        Log.e(TAG, "drawData mCurrentSelected: " + mCurrentSelected);
        // 绘制上方data
    ...
    private void drawLine(Canvas canvas, float y) {
        ...
        canvas.drawLine(0, y, mViewWidth, y + DensityUtils.dp2px(getContext(), 1), paint);
    }
    ...
    private void drawOtherText(Canvas canvas, int position, int type) {
        Log.e(TAG, "drawOtherText: position: " + position + " type: " + type);
