...
package com.gengcon.android.fixedassets.zxing.decoding;
 ...
 */
public final class CaptureInventoryActivityHandler extends Handler {
	private static final String TAG = CaptureInventoryActivityHandler.class.getSimpleName();
	...
	private final DecodeInventoryThread decodeThread;
	private DecodeCallback decodeCallback;
	public CaptureInventoryActivityHandler(ScanInventoryActivity activity, Vector<BarcodeFormat> decodeFormats,
										   String characterSet, ViewfinderView viewfinderView, DecodeCallback decodeCallback) {
		this.activity = activity;
		this.decodeCallback = decodeCallback;
		
		decodeThread = new DecodeInventoryThread(activity, decodeFormats, characterSet,
