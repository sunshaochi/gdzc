...
public interface OnItemSwipeListener {
    /**
     * Called when the swipe action startForResult.
     */
    void onItemSwipeStart(RecyclerView.ViewHolder viewHolder, int pos);

    /**
     * Called when the swipe action is over.
     * If you change the view on the startForResult, you should reset is here, no matter the item has swiped or not.
     *
     ...
     * @param viewHolder        The ContentViewHolder which is being interacted by the User or it was
