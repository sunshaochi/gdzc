...
package com.example.print.app.PagerGridRecyclerView;
...
import static com.example.print.app.PagerGridRecyclerView.PagerConfig.Loge;
import static com.example.print.app.PagerGridRecyclerView.PagerConfig.Logi;
...
public class PagerGridLayoutManager extends RecyclerView.LayoutManager
    ...
    private void setPageIndex(int pageIndex, boolean isScrolling) {
        Loge("setPageIndex = X" +getOffsetX()  + ":Y" + isScrolling);
