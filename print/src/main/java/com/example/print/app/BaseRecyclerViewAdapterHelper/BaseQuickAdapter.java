 ...
 */
package com.example.print.app.BaseRecyclerViewAdapterHelper;
...
import com.example.print.app.BaseRecyclerViewAdapterHelper.animation.AlphaInAnimation;
import com.example.print.app.BaseRecyclerViewAdapterHelper.animation.BaseAnimation;
import com.example.print.app.BaseRecyclerViewAdapterHelper.animation.ScaleInAnimation;
import com.example.print.app.BaseRecyclerViewAdapterHelper.animation.SlideInBottomAnimation;
import com.example.print.app.BaseRecyclerViewAdapterHelper.animation.SlideInLeftAnimation;
import com.example.print.app.BaseRecyclerViewAdapterHelper.animation.SlideInRightAnimation;
import com.example.print.app.BaseRecyclerViewAdapterHelper.entity.IExpandable;
import com.example.print.app.BaseRecyclerViewAdapterHelper.loadmore.LoadMoreView;
import com.example.print.app.BaseRecyclerViewAdapterHelper.loadmore.SimpleLoadMoreView;
import com.example.print.app.BaseRecyclerViewAdapterHelper.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    /**
     * startForResult up fetch position, INSTANCE is 1.
     */
    ...
    /**
     * if showToast empty view will be return 1 or not will be return 0
     *
     * @return
     */
     ...
     * you must override the method to create new ContentViewHolder.
     *
     * @param view view
     ...
     *
     * @param isHeadAndEmpty false will not showToast headView if the data is empty true will showToast emptyView and headView
     */
    ...
    /**
     * set emptyView showToast if adapter is empty and want to showToast headview and footview
     * Call before {@link RecyclerView#setAdapter(RecyclerView.Adapter)}
     *
     ...
     *
     * @return The view to showToast if the adapter is empty.
     */
    ...
    /**
     * add animation when you want to showToast time
     *
     * @param holder
     */
    ...
    /**
     * set anim to startForResult when loading
     *
     * @param anim
     * @param index
     */
     ...
     *
     * @param firstOnly true just showToast anim when first loading false showToast anim when load the data every time
     */
